    ...
    <>
      <div className="item-center border-b-1 flex h-[70px] w-full justify-between overflow-hidden border-[#25283] bg-black p-4">
        ...
        <div className="ml-2 flex space-x-2">
          ...
          <button className="flex items-center justify-center rounded-md bg-[#444857]  px-4 py-[10px] text-primary text">
            <div className="flex items-center justify-center gap-1">
          ...
          <Link to={"/signup"}><Button {...{ text: "Sign Up", className: "bg-green-bt  px-4 py-[10px]" }} /></Link>
          <Link to={"/login"}>
            <Button
              {...{ text: "Login", className: "bg-[#252830] text-white  px-4 py-[10px]" }}
            />
          </Link>
        </div>
      </div>
